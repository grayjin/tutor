...
(function() {
    angular.module('tutorApp'.controller("AlertModalController", function($scope,modals){
        $scope.message = ( modals.params().message || "Whoa!" );
                ...
                $scope.jumpToConfirm = function() {
                    ...
                    modals.proceedTo(
                        "confirm",
                        {
                            message: "You selected" + tutorList.name,
                            confirmButton: "I want him to be your mentor",
                            denyButton: "No, I don't like his hat"
                        }
                    )
                    .then(
