  ...
  console.log('hello'),
    ...
    registerUpdate: function(req,res){
     ...
     var pg = require('pg');           
        ...
        client.connect();         
        var query = client.query('UPDATE TABLE TUTORS (TUTORID, NAME, LOCID) VALUES ('"+req.query.id+"','"+req.query.name+"',5); UPDATE TABLE STUDENTS (STUDENTID, NAME, LOCID) VALUES ('"+req.query.id+"','"+req.query.name+"',5);', function(err,result){
            if(err){
